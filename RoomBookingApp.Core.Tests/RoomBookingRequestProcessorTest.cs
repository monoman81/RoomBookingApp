...
namespace RoomBookingApp.Core
{
    public class RoomBookingRequestProcessorTest
    {
        ...
        public void Should_Save_Room_Booking_Request()
        {
            ...
            roomBooking.FullName.ShouldBe(_request.FullName);
            roomBooking.Email.ShouldBe(_request.Email);
            roomBooking.Date.ShouldBe(_request.Date);
            roomBooking.RoomId.ShouldBe(_availableRooms.First<Room>().Id);
        }
